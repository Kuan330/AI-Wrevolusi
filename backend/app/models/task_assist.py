"""Permanent one-question Task Assist records."""

import uuid
from datetime import datetime
from typing import TYPE_CHECKING

from sqlalchemy import Boolean, CheckConstraint, DateTime, ForeignKey, ForeignKeyConstraint, String, Text, UniqueConstraint
...
class TaskAssistInteraction(TimestampMixin, Base):
    """One immutable completed Task Assist exchange per user and detail."""

    __tablename__ = 'task_assist_interactions'
    __table_args__ = (
        UniqueConstraint('user_id', 'task_id', name='uq_task_assist_user_task'),
    ...
    needs_user_confirmation: Mapped[bool] = mapped_column(
