...
const model = url(readFileSync(new URL('../src/features/learning-planning/planModel.ts',import.meta.url),'utf8'));
const source = readFileSync(new URL('../src/pages/Plan/scheduleCourses.ts',import.meta.url),'utf8').replace("'../../features/learning-planning/planModel'", JSON.stringify(model));
