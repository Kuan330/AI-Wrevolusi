...
import { IloOccupationExposure, ILO_OCCUPATION_EXPOSURES, parseIloOccupationExposure, referenceOccupationCategory, countOccupationCategories } from '../src/constants/iloExposure.ts';
