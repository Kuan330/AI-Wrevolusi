  ...
  return (
    <div className={cn("divide-y divide-[#e4dce7]/70", className)}>
      <div className="py-5">
        ...
        <p className="mt-2 text-sm leading-6 text-[#574a55]">
          Higher scores indicate greater potential for your tasks to change with
          generative AI.
        </p>
      </div>
      <div className="py-5">
        <h3 className="text-sm font-semibold text-[#5a3f6c]">
          Know the limits
        </h3>
        <p className="mt-2 text-sm leading-6 text-[#574a55]">
          The score does not predict whether or when you will lose your job.
        </p>
      </div>
      <div className="py-5">
        <div className="flex items-center">
          ...
          <InfoPopover label="ILO exposure categories">
            <p>
              Official ILO occupation categories use both the mean and the
              variation of task scores. Your selected-task average does not
              determine an official occupation category.
            </p>
            <p className="mt-2">
              The six categories describe occupations, not individual tasks or
              the probability of job loss. Tasks within one occupation can have
              different scores.
            </p>
            <p className="my-3 text-xs text-[#7f7280]">
              μ = mean task score · σ = standard deviation (variation between
              task scores)
            </p>
        ...
        <p className="mt-2 text-sm leading-6 text-[#574a55]">
          Your selected-task average is not an official ILO occupation category.
        </p>
      </div>
    </div>
  );
